    ...
    <script>window.dataLayer = window.dataLayer || [];
        ...
        gtag('js', new Date());
        gtag('config', 'UA-97489509-8');</script>
                                                    ...
                                                    <tfoot class="cart__footer">
                                                        <tr>
                                                            <td colspan="3" class="cart__column"><a
                                                                    href="" class="btn btn-secondary">Trở về mua hàng</a></td>
                                                            <td colspan="3" class="cart__column text-end"><button
                                                                    type="submit" class="btn btn-primary">Đặt hàng</button></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </form>
