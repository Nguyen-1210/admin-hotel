                                        ...
                                        <div class="products-view">
                                            <div class="products-view__options view-options">
                                                ...
                                                <div class="view-options__control"><label
                                                        class="view-options__control-label" for="view-options-sort">Sắp xếp theo</label>
                                                    <div class="view-options__control-content ms-3" style="width: 126px;"><select
                                                ...
                                                <div class="view-options__control ms-3" style="width: 15%;"><label
                                                        class="view-options__control-label"
                                                        for="view-options-show">Hiện số sản phẩm</label>
                                                    <div class="view-options__control-content ms-3 w-25"><select
                                                            class="form-select form-select-sm" name=""
                                               ...
                                               <!-- prodcut -->
                                                <div class="products-list__item">
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image"><a href="index.php?act=_detalis"><img
                                                        ...
                                                        <div class="product-card__info">
                                                            ...
                                                            <div class="product-card__name"><a
                                                                    href="index.php?act=_detalis">Aluminum Chandelier</a></div>
