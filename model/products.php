...
function loadall_product_top8(){
    $sql = "SELECT *,types.name AS 'namehh', products.img AS 'imgpro' ,products.name AS 'namepro' FROM products INNER JOIN types ON products.id_type = types.id WHERE products.view>0 order by products.view desc LIMIT 0,04";
